        ...
        <ScrollView>
            <View style={styles.content}>
                ...
                <CustomText style={styles.activityType}>
                    Последнее обновление: {excursion.updated_at}
                </CustomText>
                    ...
                    <View style={styles.infoSectionContainer}>
                        ...
                        <View style={styles.infoSection}>
                            <CustomText
                                ...
                                size={TextSize.S_3XL}>
                                Цена: {excursion.netto_price}
                            </CustomText>
                            <CustomText
                                size={TextSize.S_XL}
                                style={[styles.infoDuration, styles.infoBase]}>
                                Продолжительность:{' '}
                                {excursion.order_options[0].duration.name}
                            </CustomText>
                            <CustomText
                                size={TextSize.S_LG}
                                weight={TextWeight.BOLD}
                                style={[
                                    styles.infoPaymentType,
                                    styles.infoBase,
                                ]}>
                                Тип оплаты:{' '}
                                {getPayTypeLabel(excursion.pay_type)}
                            </CustomText>
                        </View>
                    </View>
                </View>
                            ...
                            <View style={styles.sectionContainerGuideText}>
                                ...
                                <CustomText size={TextSize.S_LG}>
                                    ...
                                    <CustomText
                                        ...
                                        {excursion.host.review_rating.toFixed(
                                            1,
                                        )}{' '}
                                        / 5
                                    </CustomText>
