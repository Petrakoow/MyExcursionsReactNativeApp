export const palette = {
    light: {
        primary: '#3D4BDB', // Основной цвет для кнопок, активных элементов
        secondary: '#4F5BE8', // Дополнительный цвет (например, для ссылок)
        ...
        border: '#8B8B8B', // Цвет границ
        overlay: '#00308F', // Цвет для наложений
